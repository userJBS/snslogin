...
public class KakaoLoginController {
	...
	private final String finalRedirectUri = "/redirecturikakao";
	...
	private String requestTokenURL() {
		return String.format(
				...
				appKey, redirectUri, authorizeCode);
	}
	...
	public String login(HttpServletRequest request) {
		...
		redirectUri = request.getRequestURL().toString().replace(request.getServletPath(), finalRedirectUri);

		log.info("[Kakaologin] [로그인을 요청한 클라이언트 정보] [url : {}], [ip : {}]", redirectUri, request.getRemoteAddr());
